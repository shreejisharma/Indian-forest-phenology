@echo off
title 🌲 Forest Phenology v5 — Launcher
color 0A

echo.
echo  =========================================================
echo   🌲  Universal Indian Forest Phenology Predictor v5
echo  =========================================================
echo.
...
streamlit run app/universal_Indian_forest_phenology_v5.py --server.headless false --browser.gatherUsageStats false
